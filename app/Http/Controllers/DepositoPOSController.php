...
class DepositoPOSController extends Controller
{
    public function calcularComision(Request $request)
    {
        $monto = $request->input('monto');

        $rango = DepositoConfig::where('monto_min', '<=', $monto)
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pos')->with('success', 'Depósito registrado correctamente.');
    }
}
